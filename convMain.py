...
dataset = ImageDataset(data_path, train=True, seed=341, aug_rate=3, load_first_n=9999)
dataset.split(0.85)
dataset.validation_to_numpy()
dataset.shuffle_all(643)
print(dataset.train_answers)

torch.cuda.current_device()
net = Network(dataset=dataset, learning_rate=0.0001, enable_tb=True, device="cuda:0", weight_decay=0.00001)
net.set_train()
# print(net.net)
